...
To summarize, one player acts as the game's Director, whose sole job is to create, manage, and narrate the adventures, including the behavior of the supporting characters and the schemes of the antagonists - the villain characters. All the other players are responsible for the activities of the protagonists - the hero characters trying to survive and thrive in the adventures. However, genuinely, the director and the players co-write the ongoing storylines from each play session.
